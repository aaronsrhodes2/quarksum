...
are available but must be imported explicitly — they are NOT loaded here.
    ...
    from local_library.constants import HBAR, C, E_CHARGE
    from local_library.nucleon import neutron_mass_mev
    from local_library.universe import Universe          # explicit, on demand
    from local_library.entanglement import eta_scan     # explicit, on demand
"""
