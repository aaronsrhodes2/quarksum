...
class TestConstantsAgreement(unittest.TestCase):
    ...
    def test_xi_matches(self):
        ...
        from local_library.constants import XI as local_xi
        from quarksum.core.sigma import XI as qs_xi
    ...
    def test_qcd_fraction_matches(self):
        ...
        """
        from local_library.constants import PROTON_QCD_FRACTION
        from quarksum.core.sigma import nucleon_qcd_fraction
    ...
    def test_scale_ratio_matches(self):
        ...
        from local_library.scale import scale_ratio as local_sr
        from quarksum.core.sigma import scale_ratio as qs_sr
...
class TestAdhesionCrossValidation(unittest.TestCase):
    ...
    def test_mass_ratio_agreement(self):
        ...
        from quarksum.core.sigma import proton_mass_mev
    ...
    def test_adhesion_sigma_direction(self):
        ...
        """
        from local_library.interface.adhesion import work_of_adhesion
        from quarksum.core.sigma import proton_mass_mev
