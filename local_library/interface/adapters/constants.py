...
All values sourced from local_library.constants (CODATA measured) or
...
-----
    ...
    from local_library.interface.adapters.constants import SGConstants
...
from local_library.constants import (
...
class SGConstants:
    ...
    # ── Fundamental (CODATA 2018, from local_library.constants) ──────────
    ...
    # ── Astrophysical (DE440-measured, from local_library.interface.orbital) ─
