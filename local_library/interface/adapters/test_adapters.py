...
from local_library.interface.adapters import (
    SGAdapter, SGConstants, SGEphemeris, SGPhysicsMixin,
    sg_nbody, sg_odeint, sg_solve_ivp,
)
from local_library.interface.adapters.constants import (
...
class TestSGConstants(unittest.TestCase):
    ...
    def test_G_matches_codata(self):
        """G should be the CODATA 2018 value from local_library.constants."""
    ...
    def test_light_year_derived(self):
        """Light-year = c * yr -- both from local_library.constants."""
        from local_library.constants import C, YEAR_S
        expected = C * YEAR_S
...
class TestSGPhysicsMixin(unittest.TestCase):
    ...
    def test_sg_propagate_orbit(self):
        ...
        from local_library.interface.nbody import CelestialBody
        M = 1.989e30
        a = 1.496e11
