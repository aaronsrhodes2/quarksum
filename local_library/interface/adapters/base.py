...
-------
    ...
    from local_library.interface.adapters import SGConstants
...
class SGPhysicsMixin:
    ...
    def sg_gm(self, body_name: str) -> float:
        ...
        """
        from local_library.interface.orbital import ANCHOR_GM
        _extra = {
            "Mercury": 22_032.09,
            "Venus":   324_858.59,
    ...
    def sg_mass(self, body_name: str) -> float:
        ...
        """
        from local_library.constants import G
    ...
    def sg_density(self, material_name: str, T_K: float = 293.0,
        ...
        """
        try:
            from local_library.interface.element import MaterialElement
            ...
            from local_library.interface.element import ElementalProperties
    ...
    def sg_propagate_orbit(
        ...
        Parameters
        ----------
        bodies : list of CelestialBody from local_library.interface.nbody
        ...
        """
        from local_library.interface.nbody import NBodySystem
...
class SGAdapter:
    ...
    -------
        ...
        from local_library.interface.adapters import SGAdapter
