...
Example
-------
    from local_library.interface.adapters import SGConstants, SGEphemeris
...
from local_library.interface.adapters.base       import SGPhysicsMixin, SGAdapter
from local_library.interface.adapters.constants  import (
    SGConstants, sg_patch_astropy, sg_patch_scipy,
)
from local_library.interface.adapters.ephemeris  import SGEphemeris
from local_library.interface.adapters.integrator import (
