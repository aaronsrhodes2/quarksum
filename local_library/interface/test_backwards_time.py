...
planets) and Forest-Ruth (dt=0.25 d) from local_library.interface.nbody,
with GM values from local_library.interface.orbital (DE440-measured).
"""
...
from local_library.interface.orbital import ANCHOR_GM  # DE440 measured GM (km³/s²)
