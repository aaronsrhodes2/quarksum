...
class TestBulkModulus(unittest.TestCase):
    ...
    def test_iron_bulk_modulus_order_of_magnitude(self):
        ...
        from local_library.interface.mechanical import bulk_modulus
...
class TestYoungsModulus(unittest.TestCase):
    ...
    def test_iron_youngs_modulus(self):
        ...
        from local_library.interface.mechanical import youngs_modulus
    ...
    def test_youngs_less_than_3x_bulk(self):
        ...
        """
        from local_library.interface.mechanical import youngs_modulus, bulk_modulus
...
class TestShearModulus(unittest.TestCase):
    ...
    def test_iron_shear_modulus(self):
        ...
        from local_library.interface.mechanical import shear_modulus
    ...
    def test_shear_less_than_youngs(self):
        ...
        from local_library.interface.mechanical import shear_modulus, youngs_modulus
...
class TestTheoreticalStrength(unittest.TestCase):
    ...
    def test_theoretical_strength_positive(self):
        ...
        from local_library.interface.mechanical import theoretical_shear_strength
        from local_library.interface.surface import MATERIALS
...
class TestNagathaIntegration(unittest.TestCase):
    ...
    def test_mechanical_properties_format(self):
        ...
        from local_library.interface.mechanical import material_mechanical_properties
