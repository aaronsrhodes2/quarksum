...
Generates tangles from the camera through each pixel of the image plane.
Standard perspective projection, derived from geometry.
"""

import math
from ..geometry.primitives import Vec3, Tangle
...
class Camera:
    ...
    def tangle_for_pixel(self, u, v):
        """Generate a tangle for normalized pixel coordinates (u, v).

        u: 0 = left, 1 = right
        v: 0 = top, 1 = bottom

        Returns a Tangle from camera position through the image plane.
        """
        ...
        return Tangle(self.pos, direction)
