...
def test_photon_rendering_sigma_invariance():
    ...
    wavelengths = []
    for s in sigmas:
        event = photon_rendering_event(green_energy, s, eta_local_val=0.4153)
    ...
    event_low = photon_rendering_event(2.3, 1e-10, eta_local_val=0.4153)
    event_high = photon_rendering_event(2.3, 1.0, eta_local_val=0.4153)
